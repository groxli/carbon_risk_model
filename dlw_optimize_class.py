...
class optimize_plan(object):
    ...
    def get_initial_guess(self):
        ...
        f = open('\\Users\\Bob Litterman\\Dropbox\\EZ Climate calibration paper\\dlw code\\bestparams.txt', 'r')
    ...
    def get_initial_guess6(self):
        ...
        if self.alt_input == 0 :
            ...
            f = open('\\Users\\Bob Litterman\\Dropbox\\EZ Climate calibration paper\\dlw code\\bestparams6.txt', 'r')
        else :
    ...
    def put_optimal_plan(self, plan):
        ...
        f = open('\\Users\\Bob Litterman\\Dropbox\\EZ Climate calibration paper\\dlw code\\bestparams.txt', 'w')
        rows = int(self.my_tree.x_dim / 6)-1
        rest = rows*6
        for ip in range(0, (rows-1)*6+1, 6):
    ...
    def put_optimal_plan6(self, plan):
        ...
        f = open('\\Users\\Bob Litterman\\Dropbox\\EZ Climate calibration paper\\dlw code\\bestparams6.txt', 'w')
        rows = int(self.my_tree.x_dim / 6)-1
        rest = rows*6
        for ip in range(0, (rows-1)*6+1, 6):
            f.writelines( str(plan[ip]) + "\t" + str(plan[ip+1]) + "\t" + str(plan[ip+2]) + "\t" + str(plan[ip+3]) + "\t" + str(plan[ip+4]) + "\t" + str(plan[ip+5]) + "\n")
